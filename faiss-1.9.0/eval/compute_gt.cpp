// NOTE: replaced by local-uniform-analysis.ipynb
...
//     char filename2[100]; 
//     snprintf(filename2, sizeof(filename2), "%s_gt_distances_k%d.ivecs", param1.data(), input_k);

//     write_gt_indices(filename1, gt_indices, nq, input_k);
//     write_gt_distances(filename2, gt_distances, nq, input_k);
// }