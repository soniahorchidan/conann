...
/**
 * NOTE(fabi): This is a auncel exclusive file
 */
...
// CHANGED TO
void Error_sys::set_gt(const float* gt_D_in, const idx_t* gt_I_in){
    FAISS_THROW_IF_NOT_MSG((
        gt_D_in != nullptr && 
        gt_I_in != nullptr), 
...
// CHANGED TO
void Error_sys::set_train_point(float *D,  idx_t*I, size_t key_v, size_t nq){
...
// CHANGED TO
float Error_sys::recall( idx_t *I,  idx_t *gtI, size_t topk){
    idx* v2 = I;
    std::sort(v2, v2 + topk);
    { // de-dup v2
        int64_t prev = -1;
